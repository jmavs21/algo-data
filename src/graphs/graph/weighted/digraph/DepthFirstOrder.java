...
/**
 * Finds Depth-Search Ordering of the vertices in a wighted digraph, including:
 ...
 *     
 * Note: implementation uses a LinkedHashMap in order to mantiain insertion order (similar to a queue).
 *     where: key is vertix, and value is index (pre/order)-
 */
public class DepthFirstOrder 
{
	...
	public static void main(String[] args) throws FileNotFoundException {
		Scanner in = new Scanner(new FileReader("resources/graph/tinyEWDAG.txt"));
