...
/**
 * Algorithm for solving the single-source Longest Paths problem in Acyclic Weighted Digraphs (DAG),
 ...
 */
public class LPAcyclic 
{
	private double[] distTo;
	private EdgeDirect[] edgeTo;

	public LPAcyclic(WeightedDigraph wDigraph, int s) {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		int s = 5;
		LPAcyclic sp = new LPAcyclic(wDigraph, s);
		for (int v = 0; v < wDigraph.V(); v++) {
			if (sp.hasPathTo(v)) {
